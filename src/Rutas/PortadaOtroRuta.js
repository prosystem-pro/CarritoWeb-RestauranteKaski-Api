...
const Modelo = 'portadaotro';
const Tabla = 'PortadaOtro'
const { Listado, ObtenerPorCodigo, Buscar, Crear, Editar, Eliminar } = require('../Controladores/PortadaOtroControlador');
